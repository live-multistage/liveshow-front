...
export function LiveRailItem({ show }: { show: Show }) {
  return (
    <Link href={playHref(show)} className={styles.liveItem}>
      <div className={styles.liveThumbWrapper}>
        <SmartImage src={show.image} alt={show.title} className={styles.liveThumb} />
...
export function UpcomingRailItem({ show, localeCode }: { show: Show; localeCode: string }) {
  return (
