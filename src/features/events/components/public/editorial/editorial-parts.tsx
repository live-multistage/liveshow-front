...
// component, and ride into the client bundle where a client island (the hero
// carousel) imports the helpers. Cards are ShowCard (size="compact"), the
// same one the Programação grid uses.
