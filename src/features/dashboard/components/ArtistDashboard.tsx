...
export function ArtistDashboard() {
  ...
  return (
    <div className={styles.wrapper}>
      <h1 className={styles.heading}>Artist Overview</h1>
      ...
      <div className={styles.grid}>
        <div className={styles.card}>
          ...
          <p className={styles.cardLabel}>Total Streams</p>
          <p className={styles.cardHint}>All your events</p>
        </div>
        ...
        <div className={styles.card}>
          ...
          <p className={styles.cardHint}>Currently on air</p>
        </div>
        ...
        <div className={styles.card}>
          ...
          <p className={styles.cardHint}>Scheduled streams</p>
        </div>
        ...
        <div className={styles.card}>
          ...
          <p className={styles.cardHint}>Completed streams</p>
        </div>
      </div>
      ...
      <div className={styles.section}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle}>Streams Recentes</h2>
        ...
        {!isLoading && recentEvents.length === 0 && (
          <p className={styles.eventsEmpty}>Nenhum stream criado ainda.</p>
        )}
