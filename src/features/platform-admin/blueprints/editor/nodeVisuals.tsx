import {
  Bell, Bookmark, BookmarkCheck, CircleHelp, Clock, Database, Flag, GitBranch, Mail, Ticket, User, Zap, type LucideIcon,
} from 'lucide-react';
...
const ICON_BY_KEY: Record<string, LucideIcon> = {
  ...
  'core.end': Flag, 'notifications.inApp': Bell, 'mailing.sendEmail': Mail,
};
